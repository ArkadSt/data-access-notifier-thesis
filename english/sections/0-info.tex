...
\textbf{Keywords:} Data Tracker, \textit{Andmejälgija}, personal data, state databases, data access, data access monitoring, Android, Estonian e-governance
...
\keywords{Andmejälgija, isikuandmed, riiklikud andmekogud, andmetele juurdepääs, andmetele juurdepääsu jälgimine, Android, Eesti e-riik}
